...
DEFAULT_CONFIG = {
    ...
    "templates": {
        ...
        "monthly_card":['monthly_card_01.png', 'monthly_card_02.png', 'monthly_card_03.png', 'monthly_card_04.png'],
...
def recursive_update(default_dict, user_dict):
    """递归更新字典，补全缺失的键"""
...
def get_img_paths(cfg, key):
    """从配置中获取图片的绝对路径列表"""
    base_path = get_base_path()
    filenames = cfg['templates'].get(key, [])
